    ...
    <div className="bg-slate-50 pb-20 md:pb-8">
      ...
      <div className="bg-white border-b border-slate-100 sticky top-0 z-10">
        <div className="max-w-xl mx-auto px-4 md:px-6 py-3 md:py-4 flex items-center gap-3">
          ...
          <h1 className="text-lg md:text-xl font-bold text-slate-900">{t("reportIssueTitle")}</h1>
        </div>
      </div>

      <div className="max-w-xl mx-auto px-4 md:px-6 py-4 md:py-8">
        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
          <div className="p-4 md:p-8 space-y-4 md:space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg md:rounded-xl border border-slate-100 text-slate-600">
            ...
            <div className="space-y-2">
              ...
              <div
                className="h-40 rounded-lg md:rounded-xl border-2 border-dashed border-slate-200 bg-slate-50 hover:bg-blue-50 hover:border-blue-200 transition-colors cursor-pointer flex flex-col items-center justify-center text-center p-4 group"
            ...
            <div className="space-y-2">
              ...
              <textarea
                className="w-full h-32 p-3 bg-slate-50 rounded-lg md:rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all placeholder:text-slate-400"
                placeholder={t("descriptionPlaceholder")}
              ></textarea>
            </div>

            {/* Submit */}
            <button className="w-full h-11 bg-[#006DC4] hover:bg-[#005a9f] text-white rounded-lg md:rounded-xl font-bold shadow-lg shadow-blue-500/20 active:scale-[0.98] transition-all">
              {t("submitReport")}
            </button>
          </div>
