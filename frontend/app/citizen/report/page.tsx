        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
          <div className="p-6 md:p-8 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-xl border border-slate-100 text-slate-600">
                ...
                <button className="ml-auto text-xs font-bold text-blue-600 hover:text-blue-700">Change</button>
              </div>
            </div>
              ...
              >
                {isUploading ? (
                  <div className="space-y-2">
                    ...
                    <p className="text-xs font-bold text-blue-600">AI Analysis in progress...</p>
                  </div>
                ) : (
                  <>
                    ...
                    <p className="text-sm font-medium text-slate-600">Tap to take photo</p>
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                placeholder="Describe what you see (e.g., water level rising rapidly, blocked drain...)"
              ></textarea>
            </div>
          ...
          <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 text-center">
            <p className="text-xs text-slate-500">
              Your report will be verified by our <strong>AI System</strong> instantly.
            </p>
          </div>
        </div>
